...
/**
 * Base class to test a particular {@link BaseContentProviderDaoTest}
 * implementation.
 * Performs some generic CRUD tests, then can be extended with custom tests.
 */
public abstract class BaseContentProviderDaoTest<
        Provider extends ContentProvider, 
        Dao extends BaseContentProviderDao<Item>,
        Item extends SettableId>
extends ProviderTestCase2<Provider>
{
    ...
    // -------------------------------------------- Constructors
    public BaseContentProviderDaoTest(Class<Provider> ProviderClass, String providerAuthority) {
    ...
    public void testInsertGetUpdateAndDeleteItem() {
        ...
        assertEquals("Wrong affected items", 0, affected);
        affected = mDaoToTest.deleteItem(mContext, BaseContentProviderDao.NOT_FOUND);
        assertEquals("Wrong affected items", 0, affected);
    ...
    /**
     * Test {@link BaseContentProviderDao#deleteAllItems(Context)} method 
     */
    ...
    /**
     * Tests {@link BaseContentProviderDao#getAllItemsCount(Context)} method
     */
    ...
    protected void checkNotExistingItems() {
        ...
        assertNull("Item not null", actualItem);
        actualItem = mDaoToTest.getItem(mContext, BaseContentProviderDao.NOT_FOUND);
        assertNull("Item not null", actualItem);
