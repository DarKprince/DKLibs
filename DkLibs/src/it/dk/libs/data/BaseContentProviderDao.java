 ...
 * on {@link ContentProvider} objects.
 * 
 * Unique prerequisite for the object, is to have a numerical (long) id
 */
public abstract class BaseContentProviderDao<T extends SettableId> {
    // ------------------------------------------ Private Fields
    ...
    // -------------------------------------------- Constructors
    public BaseContentProviderDao(ILogger logFacility) {
     ...
     * of the standard one.
     * 
     * @param mockContentResolver new {@link ContentResolver} to use. Pass <code>null</code> to use
     *  the standard.
     */
     ...
     * 
     * @param context a {@link Context} or an {@link Activity}, better the latter
     * @param itemId
     * @return
     */
    ...
    /**
     * Transform a {@link Cursor} into an item
     *
     * @param cursor
    ...
    /**
     * Returns the {@link ContentResolver} to use, could be the real one or
     * a mock for tests
     * 
     * @param context
     * @return
    ...
    /**
     * Performs a query using the {@link ContentResolver} if a {@link Context} is used
     *  as parameter, otherwise with {@link Activity#managedQuery(Uri, String[], String, String[], String)}
     *  if the parameter is an {@link Activity}.
     *
     * @param context a {@link Context} or an {@link Activity}, better the latter
     * @param uri
     * @param projection
